...
from src.models.qlora_model import load_qlora_model
...
def main():
    ...
    print("正在加载模型...")
    # 合并 QLoRA 配置
    qlora_config = config['qlora'].copy()
    qlora_config['lora'] = config['lora']
    ...
    training_args = TrainingArguments(
        output_dir=config['training']['output_dir'] + "/qlora",
    ...
    # 保存模型
    output_dir = Path(config['training']['output_dir']) / "qlora" / "final"
